package co.istad.quizera.project.controller;//package co.istad.quizera.project.controller;
//
...
public class UserController {
    ...
    @PutMapping("/become-teacher")
    public ResponseEntity<?> becomeTeacher(Authentication auth) {
        userService.becomeTeacher(auth.getName());
        return ResponseEntity.ok(Map.of("message", "User is now TEACHER"));
    }
}